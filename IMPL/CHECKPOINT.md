...
- **Session paused 2026-06-10 20:20 EDT** (user token budget); resume scheduled 22:15 EDT (one-shot cron in-session; if the session died, just say "go" — the loop re-anchors from this file).
