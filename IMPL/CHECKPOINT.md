...
- **In-progress task:** _(none — next: 18.27 multi-select linking [newest user feedback], then 18.23 column picker → 18.24 docking → 18.25 audit trail → 18.26 demo telemetry)_
