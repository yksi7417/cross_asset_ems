...
class SorFsmGeneratedTest {
  ...
  @Test
  void test_SENT_SorStrategyDecided_to_SENT() {
    var ctx = minimalCtx();
  ...
  @Test
  void test_WORKING_SorPlanAdjusted_to_WORKING() {
    var ctx = minimalCtx();
  ...
  void test_PENDING_CANCEL_AT_VENUE_RouteCancelRejected_to_WORKING() {
    ...
    var ctx = new SorFsmContext("default", "default", "default", "default", "default", "default", 0, 0L, null, 0L, 0L, 0L, "default", "0", "default");
  ...
  void test_PENDING_CANCEL_AT_VENUE_RouteCancelRejected_to_PARTIALLY_FILLED() {
    ...
    var ctx = new SorFsmContext("default", "default", "default", "default", "default", "default", 0, 0L, null, 0L, 0L, 0L, "default", "1", "default");
    var result = SorFsmRunner.transition(PENDING_CANCEL_AT_VENUE, RouteCancelRejected, ctx, createRouteCancelRejectedPayload());
    assertFalse(result.isNoTransition(), "Expected transition from PENDING_CANCEL_AT_VENUE on RouteCancelRejected");
  ...
  @Test
  void test_no_trans_PENDING_SorStrategyDecided() {
    var ctx = minimalCtx();
  ...
  @Test
  void test_no_trans_PENDING_SorPlanAdjusted() {
    var ctx = minimalCtx();
  ...
  @Test
  void test_no_trans_SENT_SorPlanAdjusted() {
    var ctx = minimalCtx();
  ...
  @Test
  void test_no_trans_PENDING_NEW_AT_VENUE_SorStrategyDecided() {
    var ctx = minimalCtx();
  ...
  @Test
  void test_no_trans_PENDING_NEW_AT_VENUE_SorPlanAdjusted() {
    var ctx = minimalCtx();
  ...
  @Test
  void test_no_trans_WORKING_SorStrategyDecided() {
    var ctx = minimalCtx();
  ...
  @Test
  void test_no_trans_PENDING_REPLACE_AT_VENUE_SorStrategyDecided() {
    var ctx = minimalCtx();
  ...
  @Test
  void test_no_trans_PENDING_REPLACE_AT_VENUE_SorPlanAdjusted() {
    var ctx = minimalCtx();
  ...
  @Test
  void test_no_trans_PENDING_CANCEL_AT_VENUE_SorStrategyDecided() {
    var ctx = minimalCtx();
  ...
  @Test
  void test_no_trans_PENDING_CANCEL_AT_VENUE_SorPlanAdjusted() {
    var ctx = minimalCtx();
  ...
  @Test
  void test_no_trans_PARTIALLY_FILLED_SorStrategyDecided() {
    var ctx = minimalCtx();
  ...
  @Test
  void test_no_trans_PARTIALLY_FILLED_SorPlanAdjusted() {
    var ctx = minimalCtx();
  ...
  @Test
  void test_no_trans_FILLED_SorStrategyDecided() {
    var ctx = minimalCtx();
  ...
  @Test
  void test_no_trans_FILLED_SorPlanAdjusted() {
    var ctx = minimalCtx();
  ...
  @Test
  void test_no_trans_CANCELED_SorStrategyDecided() {
    var ctx = minimalCtx();
  ...
  @Test
  void test_no_trans_CANCELED_SorPlanAdjusted() {
    var ctx = minimalCtx();
  ...
  @Test
  void test_no_trans_REJECTED_SorStrategyDecided() {
    var ctx = minimalCtx();
  ...
  @Test
  void test_no_trans_REJECTED_SorPlanAdjusted() {
    var ctx = minimalCtx();
  ...
  @Test
  void test_no_trans_EXPIRED_SorStrategyDecided() {
    var ctx = minimalCtx();
  ...
  @Test
  void test_no_trans_EXPIRED_SorPlanAdjusted() {
    var ctx = minimalCtx();
  ...
  @Test
  void test_no_trans_SUPERSEDED_SorStrategyDecided() {
    var ctx = minimalCtx();
  ...
  @Test
  void test_no_trans_SUPERSEDED_SorPlanAdjusted() {
    var ctx = minimalCtx();
  ...
  @Test
  void test_no_trans_ANOMALY_SorStrategyDecided() {
    var ctx = minimalCtx();
  ...
  @Test
  void test_no_trans_ANOMALY_SorPlanAdjusted() {
    var ctx = minimalCtx();
