...
- **Last completed task:** 18.10 — Maker-checker `(05e11e4)`. ApprovalWorkflow: deferred-command proposals, author/approver tags (CFG-1101/1102), self-approval barred (CFG-1201), TTL expiry, FAILED-apply visibility, control.approvals stream; proven on a governed restricted-list change. 7 tests.
- **In-progress task:** _(none — next: 11.17 FX ESP streaming, then 18.11 click-to-trade; 18.5 last)_
- **WIP branch:** main
- **Last updated:** 2026-06-11
- **Phase 18 progress:** 18.12 `068cbee`, 18.13 `8253d2f`, 18.1 `fefdc9a`, 18.14 `715c3d7`, 18.2 `bfdddba`, 18.3 `3554682`, 18.4 `6aa282c`, 18.6 `9c3e89f`, 18.7 `f007a19`, 18.8 `4a2e5e5`, 18.9 `b217889`, 18.10 `05e11e4`. Remaining: 18.5, 18.11 (+11.17).
...
- **Total progress:** **138 of 177 tasks [x]** (78.0%). MVP v0, Phase 16, v1 build-out complete; Phase 18 underway.
