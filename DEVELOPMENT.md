...
# 5. Bring up the dev infrastructure stack
./scripts/dev/start-dev-stack.sh

# 6. Verify the OTel pipeline works end-to-end
...
- **`gradlew: command not found`** — run `gradle wrapper --gradle-version=8.10` once to materialize it.
