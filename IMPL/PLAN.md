...
- [~] **18.20** Grid selection model round 2 (user feedback 2026-06-11) — right-click selects the row under the cursor (pointer truth; no stale-selection actions), visible row highlighting that survives streaming redraws, shift+click range select, keyboard selection (arrows / shift+arrows / page keys) (sonnet) ← blocks: 18.18
