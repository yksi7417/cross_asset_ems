...
Every cross-component interaction in the EMS is defined here. **Source of truth** for codegen into Java and C++.

## Layout

| Folder | What | Owners |
|---|---|---|
| `sbe/` | SBE XML schemas: envelopes, messages, instrument templates, events. Codegen produces both Java and C++ bindings. | Architecture team |
...
- `cpp/<module>/include/<module>/generated/` (CMake-driven codegen output).
