...
/**
 * Centralized OpenTelemetry attribute keys for the EMS. Every span, every metric exemplar, every
 * log record should attach these where applicable. Mapping is per {@code arch-observability.md
 * §"Span attributes — required minimum"}.
 *
 * <p>Attribute naming follows OpenTelemetry semantic conventions ({@code ems.*} custom namespace)
 * and the domain spec ({@code ems.session_id}, {@code ems.firm_id}, etc.).
 */
public final class EmsSpanAttributes {
  ...
  public static final AttributeKey<String> FIRM_ID = AttributeKey.stringKey(NAMESPACE + "firm_id");
  public static final AttributeKey<String> DESK_ID = AttributeKey.stringKey(NAMESPACE + "desk_id");
  public static final AttributeKey<String> USER_ID = AttributeKey.stringKey(NAMESPACE + "user_id");
  ...
  public static final AttributeKey<String> VENUE = AttributeKey.stringKey(NAMESPACE + "venue");
  public static final AttributeKey<String> MIC = AttributeKey.stringKey(NAMESPACE + "mic");

  // ---- asset class / instrument ----
  public static final AttributeKey<String> ASSET_CLASS =
      AttributeKey.stringKey(NAMESPACE + "asset_class");
  public static final AttributeKey<String> SYMBOL = AttributeKey.stringKey(NAMESPACE + "symbol");
  public static final AttributeKey<String> CUSIP = AttributeKey.stringKey(NAMESPACE + "cusip");
  public static final AttributeKey<String> ISIN = AttributeKey.stringKey(NAMESPACE + "isin");
  ...
  public static final AttributeKey<String> POD = AttributeKey.stringKey(NAMESPACE + "pod");
  public static final AttributeKey<String> HOST = AttributeKey.stringKey(NAMESPACE + "host");
