...
- **Last completed task:** 18.14 — Watchlist panel `(715c3d7)`. `DeskWatchlist` per-desk lists → bridge attach/detach + WatchRow/WatchRemoved deltas on watchlist.{desk}; logon response carries firm/desk/user; desktop watchlist grid (figi-indexed) filters the md firehose to the desk set with last-image merge. 5 tests.
- **In-progress task:** _(none — next: 18.2 order ticket + staging UI)_
- **WIP branch:** main
- **Last updated:** 2026-06-11
- **Phase 18 progress:** 18.12 `068cbee`, 18.13 `8253d2f`, 18.1 `fefdc9a`, 18.14 `715c3d7`. Remaining: 18.2–18.11 (+11.17 for 18.11).
...
- **Total progress:** **130 of 177 tasks [x]** (73.4%). MVP v0, Phase 16, v1 build-out complete; Phase 18 underway.
