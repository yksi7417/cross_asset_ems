...
/**
 * Centralized metric names for the EMS Prometheus / Grafana stack. Naming follows Prometheus
 * conventions and {@code arch-observability.md §"Metric taxonomy"}:
 *
 * <ul>
 *   <li>Counters: {@code ems_*_total}
 *   <li>Histograms: {@code ems_*_duration_seconds} (time) or {@code ems_*_size_bytes} (size)
 *   <li>Gauges: {@code ems_*_active} (in-flight) or {@code ems_*_current} (state)
 * </ul>
 *
 * <p>Reference these constants instead of stringly-typed literals so renaming and querying tooling
 * can stay in sync.
 */
public final class EmsMetricNames {
  ...
  public static final String ROUTE_ROUND_TRIP_LATENCY_SECONDS =
      PREFIX + "route_round_trip_latency_seconds";
  ...
  public static final String SOR_DECISION_DURATION_SECONDS =
      PREFIX + "sor_decision_duration_seconds";
  ...
  public static final String SESSION_HEARTBEAT_LATENCY_SECONDS =
      PREFIX + "session_heartbeat_latency_seconds";
  ...
  public static final String FSM_INVALID_TRANSITIONS_TOTAL =
      PREFIX + "fsm_invalid_transitions_total";
  ...
  public static final String EVENT_LOG_APPEND_LATENCY_SECONDS =
      PREFIX + "event_log_append_latency_seconds";
