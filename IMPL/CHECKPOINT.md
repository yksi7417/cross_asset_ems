...
- **Last completed task:** 18.9 — Enterprise SSO `(b217889)`. Dependency-free OIDC (RS256/HS256 via JDK crypto, iss/aud/exp/nbf), SCIM 2.0 Users provisioning (record wins over JIT claims, groups→tags, deactivate revokes credential), REST /api/v1/sso/oidc + /scim/v2/Users. 7 tests w/ real RSA tokens.
- **In-progress task:** _(none — next: 18.10 maker-checker approvals)_
- **WIP branch:** main
- **Last updated:** 2026-06-11
- **Phase 18 progress:** 18.12 `068cbee`, 18.13 `8253d2f`, 18.1 `fefdc9a`, 18.14 `715c3d7`, 18.2 `bfdddba`, 18.3 `3554682`, 18.4 `6aa282c`, 18.6 `9c3e89f`, 18.7 `f007a19`, 18.8 `4a2e5e5`, 18.9 `b217889`. Remaining: 18.5, 18.10, 18.11 (+11.17).
...
- **Total progress:** **137 of 177 tasks [x]** (77.4%). MVP v0, Phase 16, v1 build-out complete; Phase 18 underway.
